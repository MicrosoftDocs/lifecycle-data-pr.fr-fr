...
ms.locfileid: "940834"
---
# <a name="lifecycle-data-export"></a><span data-ttu-id="bf56b-103">Exportation de données de cycle de vie</span><span class="sxs-lookup"><span data-stu-id="bf56b-103">Lifecycle data export</span></span>

> [!IMPORTANT]
> <span data-ttu-id="bf56b-104">Cette page est en cours de développement.</span><span class="sxs-lookup"><span data-stu-id="bf56b-104">This page is under development.</span></span>

## <a name="export-all-products"></a><span data-ttu-id="bf56b-105">Exporter tous les produits</span><span class="sxs-lookup"><span data-stu-id="bf56b-105">Export all products</span></span>
<span data-ttu-id="bf56b-106">Exportez les données de cycle de vie de tous les produits en cliquant ci-dessous :</span><span class="sxs-lookup"><span data-stu-id="bf56b-106">Export lifecycle data for all products by clicking below:</span></span>

> [!div class="nextstepaction"]
> [<span data-ttu-id="bf56b-107">Exporter tous les produits</span><span class="sxs-lookup"><span data-stu-id="bf56b-107">Export All Products</span></span>](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export)

## <a name="export-products-by-family-and-group"></a><span data-ttu-id="bf56b-108">Exporter des produits par famille et par groupe</span><span class="sxs-lookup"><span data-stu-id="bf56b-108">Export products by Family and Group</span></span>
<span data-ttu-id="bf56b-109">Sélectionnez une famille, puis un groupe à exporter.</span><span class="sxs-lookup"><span data-stu-id="bf56b-109">Select a Family and then a Group to export.</span></span> <span data-ttu-id="bf56b-110">Remarque : l’exportation commence lorsque la valeur de groupe est sélectionnée.</span><span class="sxs-lookup"><span data-stu-id="bf56b-110">Note: Export will begin when Group value is selected.</span></span> 
...
> - [(Microsoft Edge | Tous les](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export?$filter=parent%20ne%20null%20and%20parent/parent%20ne%20null%20and%20parent/parent/parent%20ne%20null%20and%20parent/parent/parent/name%20eq%20'Microsoft%20Edge')
> - [(Microsoft Edge | Cadre](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export?$filter=parent%20ne%20null%20and%20parent/parent%20ne%20null%20and%20parent/parent/parent%20ne%20null%20and%20parent/parent/parent/name%20eq%20'Microsoft%20Edge'%20and%20parent/parent/name%20eq%20'Edge')
...
## <a name="export-products-by-end-of-support-date"></a><span data-ttu-id="bf56b-171">Exporter les produits par date de prise en charge</span><span class="sxs-lookup"><span data-stu-id="bf56b-171">Export products by end of support date</span></span>
<span data-ttu-id="bf56b-172">Sélectionnez une année pour afficher les produits atteignant la fin de l’assistance.</span><span class="sxs-lookup"><span data-stu-id="bf56b-172">Select a year to see products reaching the end of support.</span></span> <span data-ttu-id="bf56b-173">Remarque : l’exportation commence lorsque la valeur année est sélectionnée.</span><span class="sxs-lookup"><span data-stu-id="bf56b-173">Note: Export will begin when Year value is selected.</span></span>
