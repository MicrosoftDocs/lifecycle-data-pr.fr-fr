...
---
# <a name="lifecycle-data-export"></a>Exportation des données sur le cycle de vie

## <a name="export-all-products"></a>Exporter tous les produits
Exporter les données du cycle de vie pour tous les produits en cliquant ci-dessous :

> [!div class="nextstepaction"]
> [Exporter tous les produits](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export)

## <a name="export-products-by-family-and-group"></a>Exporter les produits par famille et groupe
Sélectionnez une famille, puis un groupe à exporter. Remarque : L’exportation commence lorsque la valeur du groupe est sélectionnée. 
...
## <a name="export-products-by-end-of-support-date"></a>Exporter des produits avant la fin de la date de support
Sélectionnez une année pour voir quels produits y atteignent la fin du support. Remarque : L’exportation commence lorsque la valeur de l’année est sélectionnée.
